    ...
    <div class="modal-dialog modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="cs_detailLabel">Detail Data Customer Service!</h5>
            ...
            <div class="modal-body" id="detail_body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="id_user" name="id_user" hidden required
            ...
            <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-danger" id="deleteCS" name="deleteCS">Delete</button>
                <button type="submit" class="btn btn-warning" id="resetCS" name="resetCS">Reset</button>
            </div>
            <?php echo form_close(); ?>
        </div>
    </div>
