            ...
            <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                <div class="widget-content widget-content-area br-6">
                    <button type="button" class="btn btn-primary mb-1" style="margin-top: 14px; margin-left: 14px;"
                        data-toggle="modal" data-target="#CetakTransaksi" id="#CetakTransaksiBaru">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <a id="detail_order"
                                        href="<?= base_url('owner/transaksi/invoice/' . $Data_transaksi->id_transaksi) ?>"
...
<?php $this->load->view('Owner/laporan/transaksi/cetak_laporan') ?>
<script>
setTimeout(function() {
    $('#gagal_tanggal').hide()
}, 3000);
