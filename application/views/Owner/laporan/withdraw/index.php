                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <center>
                                        <img src="<?= base_url('assets/profile/' . $Data_freelance->profile) ?>"
                                            style="width: 48px;"></img>
                                    </center>
                                </td>
                                <td>
                                    <?= $Data_freelance->nm_lengkap ?>
                                </td>
                                <td><?= $Data_freelance->email ?></td>
                                <td>
                                    <center>
                                        <?= $Data_freelance->no_hp ?><br><?php
                                                                                if ($Data_freelance->j_kelamin == 0) :
                                ...
                                <td class="text-center"><?= date('d F Y', strtotime($Data_freelance->tgl_gabung)) ?>
                                </td>
                                <td>
                                    <center>
                                        <?php
                                            if ($Data_freelance->status_aktif == 'AKTIF') :
                                ...
                                <td>
                                    <center>
                                        <a href="<?= base_url('owner/reports/gaji/detail/' . $Data_freelance->id_user) ?>"
                                            class="bs-tooltip" data-placement="top" title=""
                                            data-original-title="Detail Withdraw">
