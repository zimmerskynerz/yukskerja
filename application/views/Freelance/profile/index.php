<div id="content" class="main-content">
                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 layout-spacing">
                            <div class="info">
                                ...
                                <?php echo form_open_multipart('cust-freelance/profile/crud'); ?>
                                <div class="row">
                                    <div class="col-lg-11 mx-auto">
                                        <div class="row">
                                            <div class="col-xl-2 col-lg-12 col-md-4">
                                                <div class="upload mt-4 pr-md-4">
                                                    <input type="file" id="input-file-max-fs" name="input-file-max-fs"
                                                        class="dropify"
                                                        data-default-file="<?= base_url('assets/profile/' . $identitas['profile']) ?>"
                                                        data-max-file-size="10M" />
                                                    <input type="text" id="foto_lama" name="foto_lama" hidden
                                                        value="<?= $identitas['profile'] ?>">
                                                </div>
                                            </div>
                                                ...
                                                <div class="form">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="id_user" name="id_user" hidden
                                                            value="<?= $identitas['id_user'] ?>">
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="no_hp">Nomor HP</label>
                                                        <?php if ($identitas['no_hp'] > 0) : ?>
                                                        <input type="text" class="form-control mb-4" id="no_hp" readonly
                                                            placeholder="Masukkan Email Anda"
                                                            value="<?= $identitas['no_hp'] ?>">
                                                        <?php else : ?>
                                                        <input type="text" class="form-control mb-4" id="no_hp"
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-6">
                                                            <div class="form-group">
                                                                ...
                                                                <select class="form-control" id="ktp" name="ktp"
                                                                    readoonly>
                                                        ...
                                                        <div class="col-sm-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control mb-4" id="no_id"
                                                                    placeholder="Masukkan Nama Lengkap Anda" readonly
                                                                    value="<?= $identitas['no_id'] ?>">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <textarea name="alamat" id="alamat" cols="30" rows="3"
                                                            class="form-control mb-4"><?= $identitas['alamat'] ?></textarea>
                                                    </div>
                                                    <div class="form-group">
                                                    ...
                                                    <div class="col-md-12 text-right mb-5">
                                                        <button type="button" class="btn btn-secondary mb-1"
                                                            ...
                                                            data-toggle="modal" data-target="#ubahEmail"
                                                            id="#ubahEmailBaru">Ubah Email</button>
                                                        <button type="button" class="btn btn-danger mb-1"
                                                            style="margin-top: 14px; margin-left: 14px;"
                                                            data-toggle="modal" data-target="#ubahPass"
                                                            id="#ubahPassBaru">Ubah Password</button>
                                                        <button type="submit" class="btn btn-success mb-1"
                                                            style="margin-top: 14px; margin-left: 14px;"
                                                            id="simpan_profile" name="simpan_profile">Ubah
                                                            Identitas</button>
                                                    </div>
                                                </div>
                                            </div>
    ...
    <?php $this->load->view('Freelance/profile/ubahemail') ?>
    <?php $this->load->view('Freelance/profile/ubahpassword') ?>
    <script>
    setTimeout(function() {
        $('#gagal_simpan').hide()
    }, 3000);
