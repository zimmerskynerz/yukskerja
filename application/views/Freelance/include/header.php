...
<!-- Mirrored from designreset.com/cork/ltr/demo6/ by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 28 Aug 2021 03:56:44 GMT -->

<head>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1, shrink-to-fit=no">
    <title>MENU <?= $menu ?> | SELAMAT DATANG <?= $data_login['nm_lengkap'] ?></title>
    ...
    <!-- TinyMCE -->
    <script src="https://cdn.tiny.cloud/1/ggh6of9p7il21nmhguirigwjsy50txu87zz5tlv6egb00ytw/tinymce/5/tinymce.min.js"
        ...
        <header class="header navbar navbar-expand-sm">
            ...
            <ul class="navbar-nav theme-brand flex-row  text-center">
                <li class="nav-item theme-logo">
                    <a href="<?= base_url() ?>">
                        <img src="<?= base_url('assets') ?>/img/yk.png" class="navbar-logo" alt="logo">
                    </a>
                </li>
