    ...
    <div class="modal-dialog modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="order_detailLabel">Konfirmasi Proses Kerja!</h5>
            ...
            <div class="modal-body" id="detail_body">
                <?php echo form_open_multipart('cust-freelance/transaksi/order/crud'); ?>
            ...
            <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-primary" id="mulai_kerja" name="mulai_kerja">Mulai Kerja</button>
            </div>
            <?php echo form_close(); ?>
        </div>
    </div>
