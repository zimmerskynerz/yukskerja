...
<!-- Mirrored from designreset.com/cork/ltr/demo6/auth_pass_recovery_boxed.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 28 Aug 2021 03:59:57 GMT -->
<head>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1, shrink-to-fit=no">
    <title>Selamat Datang Di Yuks Kerja.com | Lupa Kata Sandi</title>
            ...
            <div class="form-form-wrap">
                <div class="form-container">
                    <div class="form-content">
                        ...
                        <p class="signup-link recovery">Masukkan Email Anda Untuk Mereset Password</p>
                        <form class="text-left">
                            <div class="form">
                                ...
                                <p class="signup-link">Sudah Ingat ? <a href="<?= base_url('login') ?>">Masuk!</a></p>
                            </div>
                        </form>
                    </div>                    
                </div>
