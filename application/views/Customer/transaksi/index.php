        ...
        <div class="row layout-top-spacing" id="cancel-row">
            <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                <div class="widget-content widget-content-area br-6">
                    <?= $this->session->flashdata('berhasil_reset_pelanggan'); ?>
                        ...
                        <tbody>
                            ...
                            <?php foreach ($data_transaksi as $Data_transaksi) : ?>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a id="detail_nego" href="javascript:void(0);" class="bs-tooltip" data-toggle="modal" data-target="#nego_detail" data-placement="top" title="" data-original-title="Detail" data-id_transaksi="<?= $Data_transaksi->id_transaksi ?>">
...
<?php $this->load->view('Cust/transaksi/order/detail_data') ?>
<script>
    setTimeout(function() {
        $('#berhasil_reset_pelanggan').hide()
    }, 3000);
</script>