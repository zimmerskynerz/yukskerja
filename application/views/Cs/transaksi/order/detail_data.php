    ...
    <div class="modal-dialog modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="order_detailLabel">Konfirmasi Pembayaran!</h5>
            ...
            <div class="modal-body" id="detail_body">
                <?php echo form_open_multipart('admin/transaksi/order/crud'); ?>
            ...
            <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-primary" id="terima_manual" name="terima_manual">Terima Manual</button>
            </div>
            <?php echo form_close(); ?>
        </div>
    </div>
