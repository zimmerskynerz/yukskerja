                    ...
                    <table id="zero-config" class="table dt-table-hover" style="width:100%">
                        <thead>
                            <tr>
                                ...
                                <th style="text-align: center; font-weight: bold">KTP</th>
                                <th style="text-align: center; font-weight: bold">Selfie KTP</th>
                            ...
                            <?php foreach ($data_pelanggan as $Data_pelanggan) : ?>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <img src="<?= base_url('assets/berkas/') ?><?= $Data_pelanggan->f_ktp ?>" class="img-responsive" width="304">
                                    </td>
                                    <td class="text-center">
                                        <img src="<?= base_url('assets/berkas/') ?><?= $Data_pelanggan->fs_ktp ?>" class="img-responsive" width="304">
                                    </td>
                                    <td class="text-center">
...
<?php $this->load->view('Cs/users/freelance/detail_konfirmasi') ?>
<script>
    setTimeout(function() {
