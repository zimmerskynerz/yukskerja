                    ...
                    <table id="zero-config" class="table dt-table-hover" style="width:100%">
                        <thead>
                            <tr>
                                ...
                                <th style="text-align: center; font-weight: bold">Verifikasi</th>
                                <th class="no-content" style="text-align: center; font-weight: bold">Aksi</th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php $no = 1; ?>
                            <?php foreach ($data_freelance as $Data_pelanggan) : ?>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <?php
                                        if ($Data_pelanggan->status_verif == 'AKTIF') : ?>
                                            <span class="badge outline-badge-success">verified</span>
                                        <?php elseif ($Data_pelanggan->status_verif == 'LENGKAPI') : ?>
                                            <span class="badge outline-badge-warning">Data Belum Lengkap</span>
                                        <?php else : ?>
                                            <span class="badge outline-badge-danger">Blokir</span>
                                        <?php endif;
                                        ?>
                                    </td>
                                    <td class="text-center">
                                        ...
                                        <!-- <?php
                                                if ($Data_pelanggan->username != null) : ?>
                                            <a href="<?= base_url('admin/users/freelance/detail/' . $Data_pelanggan->username) ?>" class="bs-tooltip" data-placement="top" title="" data-original-title="Lihat Profil Lengkap">
...
<?php $this->load->view('Cs/users/freelance/detail_data') ?>
<script>
    setTimeout(function() {
