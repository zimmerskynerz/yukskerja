    ...
    <div class="modal-dialog modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="cs_detailLabel">Detail Data Pelanggan!</h5>
            ...
            <div class="modal-body" id="detail_body">
                <?php echo form_open_multipart('admin/users/freelance/crud'); ?>
                ...
                <div class="form-group">
                    <label>Nomor Handphone Customer Service</label>
                    <input type="number" class="form-control" readonly id="no_hp" name="no_hp" placeholder="Masukkan No HP">
                </div>
                <div class="form-group">
                    <label>Tanggal Lahir</label>
                    <input type="date" class="form-control" readonly id="tgl_lahir" name="tgl_lahir" placeholder="Masukkan Tanggal Lahir">
                </div>
                <div class="form-group">
                    <label>Alamat Customer Service</label>
                    <textarea type="text" class="form-control" readonly id="alamat" name="alamat" placeholder="Masukkan Alamat Rumah"></textarea>
                </div>
            </div>
            <div class="modal-footer">
                <button class="btn" data-dismiss="modal"><i class="flaticon-cancel-12"></i> Close</button>
                <button type="submit" class="btn btn-danger" id="deleteFreelance" name="deleteFreelance">Delete</button>
                <button type="submit" class="btn btn-warning" id="resetFreelance" name="resetFreelance">Reset</button>
            </div>
            <?php echo form_close(); ?>
        </div>
    </div>
