    ...
    <div class="modal-dialog modal-dialog-scrollable">
        <div class="modal-content">
            ...
            <div class="modal-body" id="detail_body">
                <?php echo form_open_multipart('admin/users/pelanggan/crud'); ?>
            ...
            <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-danger" id="deletPelanggan" name="deletPelanggan">Delete</button>
                <button type="submit" class="btn btn-warning" id="resetPelanggan" name="resetPelanggan">Reset</button>
            </div>
            <?php echo form_close(); ?>
        </div>
    </div>
